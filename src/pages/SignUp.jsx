...
import { toast } from "react-toastify";
 export default function SignUp() {
  ...
  async function onSubmit(e) {
   ...
   return (
     <section>
      <h1 className='text-3xl text-center mt-6 font-bold'>Sign Up
      </h1>
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
           <img src="https://media.istockphoto.com/id/1045872646/photo/man-holding-a-home-key-in-his-hand-and-residence-background.jpg?s=612x612&w=0&k=20&c=SI2z8vsy1cq8XMlFsKRJe6SGhMzCHW93HfPHajBAIhE=" alt="key"
