...
import OAuth from "../components/OAuth";
 export default function SignIn() {
  ...
  function onChange(e){
   ...
   return (
     <section>
      <h1 className='text-3xl text-center mt-6 font-bold'>Sign In
      </h1>
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
           <img src="https://media.istockphoto.com/id/936395172/photo/key-in-hand-of-real-estate-agent-as-offer-for-your-new-home.jpg?s=612x612&w=0&k=20&c=-GsqO8ePVFUi8U9bIVBauZFM9gm8Z20ZFeeYp3xjJk0=" alt="key"
