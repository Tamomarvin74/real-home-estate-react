...
export default function Listing() {
  ...
  <main>
    ...
    <div className="fixed mt-6 top-[13%] right-[3%] z-10 bg-white cursor-pointer border-2 border-gray-400 rounded-full w-12 h-12 flex justify-center items-center" onClick={()=>{
